...
public class WalletServiceImplTest {
    ...
    public void shouldSuccessWhenMoveMoneyGivenAmountLessThanBuyerBalance() {
        ...
        WalletServiceImpl walletServiceImpl = createWalletServiceWithUserRepo(mockedUserRepo);

        String result = walletServiceImpl.moveMoney("fake_id", 1, 2, 80);
    ...
    public void shouldFailureWhenMoveMoneyGivenAmountGreatThanBuyerBalance()
        ...
        String result = walletServiceImpl.moveMoney("fake_id", 1, 2, 180);
    ...
    private WalletServiceImpl createWalletServiceWithUserRepo(UserRepository userRepo) {
        try {
